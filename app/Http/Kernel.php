...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        // 检测是否应用是否进入『维护模式』
        // 见：https://learnku.com/docs/laravel/5.8/configuration#maintenance-mode
    ...
    protected $middlewareGroups = [
        ...
        'web' => [
            ...
            // 见：https://learnku.com/docs/laravel/5.8/csrf
            \App\Http\Middleware\VerifyCsrfToken::class,

            // 处理路由绑定
            // 见：https://learnku.com/docs/laravel/5.8/routing#route-model-binding
        ...
        'api' => [
            // 使用别名来调用中间件
            // 请见：https://learnku.com/docs/laravel/5.8/middleware#为路由分配中间件
            'throttle:60,1',
            'bindings',
        ],
    ];
